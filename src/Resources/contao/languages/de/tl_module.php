...
$GLOBALS['TL_LANG']['tl_module']['catalog_ics_legend'] = 'ICS Export-Einstellungen';

$GLOBALS['TL_LANG']['tl_module']['catalogEndDateField'] = ['Enddatum', 'Bitte wählen Sie das Enddatum aus.'];
$GLOBALS['TL_LANG']['tl_module']['catalogStartDateField'] = ['Startdatum', 'Bitte wählen Sie das Startdatum aus.'];
$GLOBALS['TL_LANG']['tl_module']['catalogICalFileName'] = ['Dateiname', 'Bitte geben Sie einen Dateinamen ein. Standardmäßig ist es der Seitenalias.'];
$GLOBALS['TL_LANG']['tl_module']['catalogUrlField'] = ['URL', 'Hier können Sie die URL eingeben. Sie können über die SimpleTokens auf die Feldwerte zugreifen z.B ##masterUrl##.'];
